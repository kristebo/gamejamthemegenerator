...
class gamejamthemes {
    ...
    randomItem(){
        let gamejamthemelist = [
            ...
            "The Cycle of Life",
            "The est Hero Ever!",
            "The Five Elements (Fire, Earth, Air, Water and  [unknown error occured])",
            "The Fleet",
        ...
        return gamejamthemelist[Math.floor(Math.random()*gamejamthemelist.length)];
    }


}
module.exports=gamejamthemes;
